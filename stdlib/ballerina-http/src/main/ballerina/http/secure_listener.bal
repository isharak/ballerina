...
function getConfigJwtAuthProviderConfig(AuthProvider authProvider) returns auth:ConfigJwtAuthProviderConfig{
    ...
    configjwtAuth.issuer = authProvider.issuer;
    configjwtAuth.expTime = authProvider.expTime;
    configjwtAuth.signingAlg = authProvider.signingAlg;
    configjwtAuth.audience = authProvider.audience;
